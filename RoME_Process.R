...
Process_NonGaussianSeries <- function(type.epsilon = c('Normal','Mixture', 'Tstudent'), times.repeat = 1e+3,
...
# Process_NonGaussianSeries(method.forecast = 'ARIMA', design.W = c('OLS', 'WLSv', 'WLSs', 'Sample', 'Shrink'))
...
# Process_ProportionOfBadForecasts(method.forecast = 'ARIMA', design.W = c('OLS', 'WLSv', 'WLSs', 'Sample', 'Shrink'))
...
# Process_Correlation(method.forecast = 'ARIMA', design.W = c('OLS', 'WLSv', 'WLSs', 'Sample', 'Shrink'))
# Process_Correlation(method.forecast = 'ETS', design.W = c('OLS', 'WLSv', 'WLSs', 'Sample', 'Shrink'))
...
# Process_LargeScale(method.forecast = 'ARIMA', design.W = c('OLS', 'WLSv', 'WLSs', 'Shrink'))